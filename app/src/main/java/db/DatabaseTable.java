...
public class DatabaseTable {
    ...
    public static abstract class Question implements BaseColumns {
        ...
        public static final String COLUMN_QUESTION_ID_LARS = "question_id_lars";
        ...
        public static final String COLUMN_IS_MULTI_SELECT = "is_multi_select";
        public static final String COLUMN_IS_ANSWERED = "is_answered";
        public static final String COLUMN_IMAGE_URL = "image_path";
    }
